...
#' @return Combined episodes
#' @export
add_ectopic <- function(add_stillbirth_df, Matcho_outcome_limits, final_ectopic_visits_df) {
  # get minimum days between outcomes
...
#' @return Combined episodes
#' @export
add_abortion <- function(add_ectopic_df, Matcho_outcome_limits, final_abortion_visits_df) {
...
#' @export
gestation_episodes <- function(gestation_visits_df, min_days = 70, buffer_days = 28, config = NULL) {
